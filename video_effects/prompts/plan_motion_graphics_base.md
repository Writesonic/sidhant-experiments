...
6. **Subtitle reserved zone.** y >= 0.78 is reserved for subtitles — never place components there.
7. **Face anchoring.** Use `anchor` to position components relative to the speaker:
